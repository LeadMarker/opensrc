...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		-- Multidropdown 
		function Tab:CreateMultidrop(settings)
		    local Multidrop = Elements.Template.Dropdown:Clone()
		    local name = settings.Name or ''
		    local options = settings.Options or {} 
		    local current_options = settings.CurrentOptions or {}
		    local selected = {}
		    
		    Multidrop.Title.Text = name
			Multidrop.Visible = true
			Multidrop.Parent = TabPage
			
			Multidrop.Selected.Text = table.concat(current_options, ',')
			
            Multidrop.BackgroundTransparency = 1
			Multidrop.UIStroke.Transparency = 1
			Multidrop.Title.TextTransparency = 1

			Multidrop.Size = UDim2.new(1, -10, 0, 45)

			TweenService:Create(Multidrop, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
			TweenService:Create(Multidrop.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			TweenService:Create(Multidrop.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()	
			
			for _, ununusedoption in ipairs(Multidrop.List:GetChildren()) do
				if ununusedoption.ClassName == "Frame" and ununusedoption.Name ~= "Placeholder" then
					ununusedoption:Destroy()
				end
			end

			Multidrop.Toggle.Rotation = 180
			Multidrop.List.Visible = false
			
            Multidrop.Interact.MouseButton1Click:Connect(function()
				TweenService:Create(Multidrop, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
				TweenService:Create(Multidrop.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
				wait(0.1)
				TweenService:Create(Multidrop, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
				TweenService:Create(Multidrop.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
				if Debounce then return end
				if Multidrop.List.Visible then
					Debounce = true
					TweenService:Create(Multidrop, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(1, -10, 0, 45)}):Play()
					for _, DropdownOpt in ipairs(Multidrop.List:GetChildren()) do
						if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" then
							TweenService:Create(DropdownOpt, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
							TweenService:Create(DropdownOpt.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
							TweenService:Create(DropdownOpt.Title, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
					...
					TweenService:Create(Multidrop.List, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ScrollBarImageTransparency = 1}):Play()
					TweenService:Create(Multidrop.Toggle, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Rotation = 180}):Play()	
					wait(0.35)
					Multidrop.List.Visible = false
					Debounce = false
				else
					TweenService:Create(Multidrop, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(1, -10, 0, 180)}):Play()
					Multidrop.List.Visible = true
					TweenService:Create(Multidrop.List, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ScrollBarImageTransparency = 0.7}):Play()
					TweenService:Create(Multidrop.Toggle, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Rotation = 0}):Play()	
					for _, DropdownOpt in ipairs(Multidrop.List:GetChildren()) do
						if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" then
							TweenService:Create(DropdownOpt, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
							TweenService:Create(DropdownOpt.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			...
			Multidrop.MouseEnter:Connect(function()
				if not Multidrop.List.Visible then
					TweenService:Create(Multidrop, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
				end
			end)

			Multidrop.MouseLeave:Connect(function()
				TweenService:Create(Multidrop, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			end)
		    ...
		    for _, Option in ipairs(options) do
				...
				DropdownOption.Name = Option
				DropdownOption.Title.Text = Option
				DropdownOption.Parent = Multidrop.List
				DropdownOption.Visible = true
				
				if table.find(current_options, Option) then
					TweenService:Create(Multidrop.List:FindFirstChild(Option), TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
				    if (not table.find(selected, Option)) then 
				        table.insert(selected, Option)
						Multidrop.Selected.Text = table.concat(selected, ',')
						...
						if not Success then
							TweenService:Create(Multidrop, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(85, 0, 0)}):Play()
							TweenService:Create(Multidrop.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
							Multidrop.Title.Text = "Callback Error"
							print("Rayfield | "..settings.Name.." Callback Error " ..tostring(Response))
							wait(0.5)
							Multidrop.Title.Text = settings.Name
							TweenService:Create(Multidrop, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
							TweenService:Create(Multidrop.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
						end
						
						settings.CurrentOptions = selected
						
						if (not table.find(settings, Option)) then
    						TweenService:Create(DropdownOption.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
    						TweenService:Create(DropdownOption, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
    						Debounce = true
    						wait(0.2)
				        ...
				        Multidrop.Selected.Text = table.concat(selected, ',')
					    TweenService:Create(Multidrop.List:FindFirstChild(Option), TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
		    ...
		    function settings:Set(option)
		        local droption = Multidrop.List:FindFirstChild(option)
		        TweenService:Create(droption, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
		        table.insert(selected, option)
		        
		        Multidrop.Selected.Text = table.concat(selected, ',')
		    end
		    
		    function settings:Add(option)
		        local DropdownOption = Elements.Template.Dropdown.List.Template:Clone()
				DropdownOption.Name = option
				DropdownOption.Title.Text = option
				DropdownOption.Parent = Multidrop.List
		    ...
		    function settings:Remove(option)
		        local droption = Multidrop.List:FindFirstChild(option)
		    ...
		    function settings:Refresh(list)
                for i, option in pairs(Multidrop.List:GetChildren()) do 
                    if option.ClassName == 'Frame' and option.Name ~= 'Placeholder' then 
                        self:Remove(option.Name)
                    end
                end
		    ...
		    if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and settings.Flag then
